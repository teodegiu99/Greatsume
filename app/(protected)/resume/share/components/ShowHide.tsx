            ...
            {() => (
                <Form id="share-settings-form" className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                            {templateOptions.map((t) => (
                                <label key={t} className="cursor-pointer">
                                    ...
                                    />
                                    <div className="p-2 text-center text-xs border rounded-lg border-slate-200 peer-checked:border-violet-600 peer-checked:bg-violet-50 peer-checked:text-violet-700 transition-all hover:bg-slate-50">
                                        {t}
                                    </div>
                                </label>
                            ))}
                    ...
                    <div className="border-t border-slate-50 pt-4">
                        <h3 className="text-sm font-semibold text-slate-800 mb-3 flex items-center gap-2">
                            <MdVisibility className="primary" />
                            Visibility Settings
                        </h3>
...
const ToggleRow = ({
    ...
    <div className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-slate-50 transition-colors">
        ...
        <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="w-10 h-5 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-violet-600"></div>
        </label>
    </div>
);
