            ...
            <div className="col-span-1 bg-[#1c2863] p-3 w-full text-white">
                ...
                <div className="flex justify-start flex-col">
                    {(data?.address || data?.dateOfBirth) && (
                        <>
                            <p className="cvTitle-ClassicBlue ">
                    ...
                    {data?.address && showHide?.showAddress && (
                        <>
                            ...
                            <p className="cvData-ClassicBlue ">
                                {data?.address}
                            </p>
                        </>
                    )}
                    {data?.dateOfBirth && showHide?.showDateOfBirth && (
                        <>
                            <p className="cvSubTitle-ClassicBlue ">
                                Date Of Birth
                            </p>
                            <p className="cvData-ClassicBlue ">
                                {data?.dateOfBirth}
                    ...
                    <div className="flex justify-start flex-col">
                        ...
                        <ul>
                            {data?.skillss.map((skill, index) => (
                                <li
                                    className="cvSubTitle-ClassicBlue "
                                    key={index}
                                >
                                    {skill}
                                </li>
            ...
            <div className="col-span-2 p-3 w-full h-full bg-white text-black">
                <div>
                    <div className="flex justify-start flex-col">
                        ...
                        {data?.desiredJob && (
                            <h2 className="cvMainSub-ClassicBlue ">
                                {data?.desiredJob}
                            </h2>
                        )}
